...
public class CommDataConfig implements Serializable {
	...
	@NotNull(message="noauthor/config.CommDataConfig.menuType.NotNull")
	private Byte menuType;

	/** menu_item -- 菜单项 */
	@Length(max=20,message="noauthor/config.CommDataConfig.menuItem.Length")
	private String menuItem;

	/** sort --  */
	@NotNull(message="noauthor/config.CommDataConfig.sort.NotNull")
	private Short sort;

	/** value -- 对应的值 */
	@NotNull(message="noauthor/config.CommDataConfig.value.NotNull")
	private Short value;

	/** createdon -- 创建时间 */
	@NotNull(message="noauthor/config.CommDataConfig.createdon.NotNull")

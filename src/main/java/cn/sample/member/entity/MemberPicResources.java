...
public class MemberPicResources implements Serializable {
	...
	/** member_id -- 会员id */
	@NotNull(message="noauthor/credit.MemberPicResources.memberId.NotNull")
	private Integer memberId;

	/** pictype -- 图片类型（0头像1身份证正面2身份证反面3人脸识别4身份证头像,5驾驶证正面6行驶证正面7行驶证反面8驾驶证背面） */
	@NotNull(message="noauthor/credit.MemberPicResources.pictype.NotNull")
	private Byte pictype;

	/** url -- 图片路径 */
	@Length(max=200,message="noauthor/credit.MemberPicResources.url.Length")
	private String url;

	/** object_type -- 图片来源类型0默认会员1贷款的图片2信用申请的图片 */
	@NotNull(message="noauthor/credit.MemberPicResources.objectType.NotNull")
	private Byte objectType;

	/** object_id -- 贷款id,信用申请id */
	@NotNull(message="noauthor/credit.MemberPicResources.objectId.NotNull")
	private Integer objectId;

	/** remark -- 备注 */
	@Length(max=30,message="noauthor/credit.MemberPicResources.remark.Length")
	private String remark;

	/** createdon -- 创建时间 */
	@NotNull(message="noauthor/credit.MemberPicResources.createdon.NotNull")
	...
	/** 获取图片类型（0头像1身份证正面2身份证反面3人脸识别4身份证头像,5驾驶证正面6行驶证正面7行驶证反面8驾驶证背面） */
	public Byte getPictype() {
		return pictype;
	}

	/** 设置图片类型（0头像1身份证正面2身份证反面3人脸识别4身份证头像,5驾驶证正面6行驶证正面7行驶证反面8驾驶证背面） */
